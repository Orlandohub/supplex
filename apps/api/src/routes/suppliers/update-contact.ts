  ...
  .patch(
    ...
    },
    {
      ...
      detail: {
        ...
        description: "Updates the supplier contact's name, email, and/or status. Automatically syncs isActive with status field and invalidates auth cache when status changes.",
        tags: ["Suppliers"],
      },
    }
  );
