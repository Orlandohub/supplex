 ...
 * - GET    /api/workflow-templates/:templateId               - Get template by ID
 * - POST   /api/workflow-templates/:templateId/copy          - Copy template (deep copy)
 * - PUT    /api/workflow-templates/:templateId               - Update template metadata
 ...
 *
 * Step Management:
 * - GET    /api/workflow-templates/:templateId/steps        - Get ordered steps
 * - POST   /api/workflow-templates/:templateId/steps        - Create step
 * - PUT    /api/workflow-templates/:templateId/steps/:stepId - Update step
 * - DELETE /api/workflow-templates/:templateId/steps/:stepId - Delete step
 * - PUT    /api/workflow-templates/:templateId/steps/reorder - Reorder steps
 */
