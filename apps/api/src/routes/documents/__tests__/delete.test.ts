...
describe("DELETE /api/documents/:id", () => {
  ...
  it("should soft delete document", async () => {
    ...
    const response = await client.api.documents[document.id].delete({
      headers: {
  ...
  it("should return 404 if document doesn't exist", async () => {
    ...
    const response = await client.api.documents[fakeId].delete({
      headers: {
        Authorization: `Bearer ${testToken}`,
      },
    });
  ...
  it("should enforce tenant isolation", async () => {
    ...
    const response = await client.api.documents[otherDocument.id].delete({
      headers: {
        Authorization: `Bearer ${testToken}`,
      },
    });
