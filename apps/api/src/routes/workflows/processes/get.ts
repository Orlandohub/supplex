      ...
      try {
        ...
        const [
          ...
          db
            ...
            .leftJoin(completedByUser, eq(taskInstance.completedBy, completedByUser.id))
            .where(
              and(
          ...
          workflowTemplateId
            ...
            : Promise.resolve([] as { stepOrder: number; requiresValidation: boolean; validationConfig: any }[]),
