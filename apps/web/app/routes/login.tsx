...
export const meta: MetaFunction = () => {
  return [
    { title: 'Sign In | Supplex' },
    { name: 'description', content: 'Sign in to your Supplex account to manage your suppliers and procurement processes.' },
  ];
};
...
export default function Login() {
  ...
  // Check for OAuth error or success messages
