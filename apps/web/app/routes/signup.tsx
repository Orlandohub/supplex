...
export const meta: MetaFunction = () => {
  return [
    { title: "Sign Up | Supplex" },
    {
      name: "description",
      content:
        "Create your Supplex account and start managing your suppliers and procurement processes.",
    },
  ];
};
...
export default function SignUp() {
  ...
  // Check for OAuth or other error messages
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-sm text-red-700">
                    {errorDescription || "An error occurred during sign up."}
                  </p>
                </div>
              </div>
            </div>
