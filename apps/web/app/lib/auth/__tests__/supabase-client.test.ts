...
describe('Supabase Client Configuration', () => {
  it('should throw error when SUPABASE_URL is missing', async () => {
    ...
    try {
      ...
      expect(error.message).toContain('Missing SUPABASE_URL environment variable');
    }
  ...
  it('should throw error when SUPABASE_ANON_KEY is missing', async () => {
    ...
    try {
      ...
      expect(error.message).toContain('Missing SUPABASE_ANON_KEY environment variable');
    }
  ...
  it('should throw error when getBrowserClient is called on server', async () => {
    ...
    expect(() => getBrowserClient()).toThrow('getBrowserClient should only be called in the browser');
